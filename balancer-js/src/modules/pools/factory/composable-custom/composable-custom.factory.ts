import { ComposableCustomCreatePoolParameters } from '@/modules/pools/factory/types';
...
export class ComposableCustomFactory implements PoolFactory {
  ...
  create({
    ...
    swapFee,
    owner,
  }: ComposableCustomCreatePoolParameters): TransactionRequest {
